...
namespace TillValhalla.Configurations.Sections
{
    public class PlayerConfiguration
    {
        ...
        public static ConfigEntry<bool> restedOnStart;
        public static ConfigEntry<float> restedDurationOnStart;
        ...
        public static void Awake(BaseUnityPlugin playercfg)
        {
            ...
            ComfortRadius = playercfg.Config.Bind("Player", "Comfort Radius", 10f, new ConfigDescription("Radius of Comfort Pieces", new AcceptableValueRange<float>(10f,300f), new ConfigurationManagerAttributes { IsAdminOnly = true }));
            restedOnStart = playercfg.Config.Bind("Player", "restedOnStart", false, new ConfigDescription("Set this to true to start with rested bonus", null, new ConfigurationManagerAttributes { IsAdminOnly = false }));
            restedDurationOnStart = playercfg.Config.Bind("Player", "restedDurationOnStart", 420f, new ConfigDescription("Duration of rested bonus on start in seconds. Needs rested on start enabled to work.", null, new ConfigurationManagerAttributes { IsAdminOnly = false }));
        }
