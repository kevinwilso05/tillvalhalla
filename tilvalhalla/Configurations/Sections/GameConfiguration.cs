...
namespace TillValhalla.Configurations.Sections
{
    public class GameConfiguration
    {
        ...
        public static void Awake(BaseUnityPlugin gamecfg)
        {
            ...
            firstspawnmessage = gamecfg.Config.Bind("Game", "firstspawnmessage", "I have arrived at an orgasm!" , new ConfigDescription("This is the message that displays when a player has arrived", null));
